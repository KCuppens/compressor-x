...
class TranslatableQuerySet(query.QuerySet):
    ...
    def _chain(self, **kwargs):
        ...
        clone._trans_lang = getattr(self, "_trans_lang")  # noqa: B009
        clone._trans_prob = getattr(self, "_trans_prob")  # noqa: B009
        clone._trans_rels = getattr(self, "_trans_rels")  # noqa: B009
